...
public :
   ...
   /*  cbshot();
    ~cbshot(); */
    static void calculate_ICP_COV(pcl::PointCloud<pcl::PointNormal>& data_pi, pcl::PointCloud<pcl::PointNormal>& model_qi, Eigen::Matrix4f& transform, Eigen::MatrixXd& ICP_COV);
    
    static void calculate_cov(pcl::PointCloud<pcl::PointXYZ>& cloud_in, pcl::PointCloud<pcl::PointXYZ>& cloud_out, Eigen::Matrix4f & iG_transf, Eigen::MatrixXd & iG_cov);
