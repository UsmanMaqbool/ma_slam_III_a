// Generated by gencpp from file cc_fabmap/keyframeMsg.msg
// DO NOT EDIT!


#ifndef CC_FABMAP_MESSAGE_KEYFRAMEMSG_H
#define CC_FABMAP_MESSAGE_KEYFRAMEMSG_H
...
struct keyframeMsg_
{
  ...
  typedef boost::shared_ptr< ::cc_fabmap::keyframeMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cc_fabmap::keyframeMsg_<ContainerAllocator> const> ConstPtr;

}; // struct keyframeMsg_

typedef ::cc_fabmap::keyframeMsg_<std::allocator<void> > keyframeMsg;

typedef boost::shared_ptr< ::cc_fabmap::keyframeMsg > keyframeMsgPtr;
typedef boost::shared_ptr< ::cc_fabmap::keyframeMsg const> keyframeMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cc_fabmap::keyframeMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cc_fabmap::keyframeMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cc_fabmap::keyframeMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cc_fabmap::keyframeMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cc_fabmap::keyframeMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x42d4108dbb7d0e5dULL;
  static const uint64_t static_value2 = 0x166eb68dd4054826ULL;
};

template<class ContainerAllocator>
struct DataType< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "cc_fabmap/keyframeMsg";
  }
...
template<class ContainerAllocator>
struct Definition< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 id\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cc_fabmap::keyframeMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cc_fabmap::keyframeMsg_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // CC_FABMAP_MESSAGE_KEYFRAMEMSG_H
