...
(cl:defmethod cl:initialize-instance :after ((m <keyframeMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keyframeMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cc_fabmap-msg:<keyframeMsg> is deprecated: use cc_fabmap-msg:keyframeMsg instead.")))
