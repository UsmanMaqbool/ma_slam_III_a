...
(cl:defmethod cl:initialize-instance :after ((m <keyframeGraphMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keyframeGraphMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cc_fabmap-msg:<keyframeGraphMsg> is deprecated: use cc_fabmap-msg:keyframeGraphMsg instead.")))
